...
const slug = "plant-tool-hire";

export const metadata: Metadata = {
  title: "Plant & Tool Hire",
  description: "Heavy plant hire including TLBs, excavators, graders, generators, scaffolding, and hand tools — delivered to site across South Africa.",
};
